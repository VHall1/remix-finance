...
export function Shell({ children }: PropsWithChildren) {
  return (
    <div className="grid h-screen [grid-template-columns:minmax(max-content,12.8125rem)_1fr] [grid-template-rows:max-content_1fr] [grid-template-areas:'logo_header''aside_main']">
      <Link
        to={rootHandle.path()}
      ...
      <Navbar />
      <nav className="grid items-start px-4 text-sm font-medium border-r bg-gray-100/40 lg:block dark:bg-gray-800/40 [grid-area:aside]">
